...
import { ProfileMenuType } from '@ms-0/modules/ms4/profile-menu/server/graphql/profile-menu.type';
import {
  CreateProfileMenuInput,
  UpdateProfileMenuInput,
  DeleteProfileMenuInput,
  SearchProfileMenuInput,
} from '@ms-0/modules/ms4/profile-menu/server/graphql/profile-menu.input';
