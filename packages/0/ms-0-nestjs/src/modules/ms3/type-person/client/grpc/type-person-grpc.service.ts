...
import { TypePersonType } from '@ms-0/modules/ms3/type-person/server/graphql/type-person.type';
import {
  CreateTypePersonInput,
  UpdateTypePersonInput,
  DeleteTypePersonInput,
  SearchTypePersonInput,
} from '@ms-0/modules/ms3/type-person/server/graphql/type-person.input';
