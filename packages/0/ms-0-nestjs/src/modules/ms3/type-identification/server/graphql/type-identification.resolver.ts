...
import { TypeIdentificationType } from '@ms-0/modules/ms3/type-identification/server/graphql/type-identification.type';
import {
  CreateTypeIdentificationInput,
  UpdateTypeIdentificationInput,
  DeleteTypeIdentificationInput,
  SearchTypeIdentificationInput,
} from '@ms-0/modules/ms3/type-identification/server/graphql/type-identification.input';
