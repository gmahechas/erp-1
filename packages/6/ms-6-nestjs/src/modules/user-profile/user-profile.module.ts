...
import { userProfileSchema } from '@ms-6/modules/user-profile/client/mongodb/user-profile.schema';
import { UserProfileGrpcController } from '@ms-6/modules/user-profile/server/grpc/user-profile-grpc.controller';
