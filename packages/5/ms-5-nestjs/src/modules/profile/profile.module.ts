...
import { profileSchema } from '@ms-5/modules/profile/client/mongodb/profile.schema';
import { ProfileGrpcController } from '@ms-5/modules/profile/server/grpc/profile-grpc.controller';
