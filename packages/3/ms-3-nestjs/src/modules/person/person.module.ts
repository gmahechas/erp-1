...
import { personSchema } from '@ms-3/modules/person/client/mongodb/person.schema';
import { PersonGrpcController } from '@ms-3/modules/person/server/grpc/person-grpc.controller';
