...
import { addressSchema } from '@ms-3/modules/address/client/mongodb/address.schema';
import { AddressGrpcController } from '@ms-3/modules/address/server/grpc/address-grpc.controller';
