...
import { estateSchema } from '@ms-3/modules/estate/client/mongodb/estate.schema';
import { EstateGrpcController } from '@ms-3/modules/estate/server/grpc/estate-grpc.controller';
