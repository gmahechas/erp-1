...
import { officeSchema } from '@ms-4/modules/office/client/mongodb/office.schema';
import { OfficeGrpcController } from '@ms-4/modules/office/server/grpc/office-grpc.controller';
