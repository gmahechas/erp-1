...
import { profileMenuSchema } from '@ms-4/modules/profile-menu/client/mongodb/profile-menu.schema';
import { ProfileMenuGrpcController } from '@ms-4/modules/profile-menu/server/grpc/profile-menu-grpc.controller';
