...
import { TypePersonType } from '@ms-api-gateway/modules/ms3/type-person/server/graphql/type-person.type';
import {
  CreateTypePersonInput,
  UpdateTypePersonInput,
  DeleteTypePersonInput,
  SearchTypePersonInput,
} from '@ms-api-gateway/modules/ms3/type-person/server/graphql/type-person.input';
