...
import { UserProfileType } from '@ms-api-gateway/modules/ms4/user-profile/server/graphql/user-profile.type';
import {
  CreateUserProfileInput,
  UpdateUserProfileInput,
  DeleteUserProfileInput,
  SearchUserProfileInput,
} from '@ms-api-gateway/modules/ms4/user-profile/server/graphql/user-profile.input';
