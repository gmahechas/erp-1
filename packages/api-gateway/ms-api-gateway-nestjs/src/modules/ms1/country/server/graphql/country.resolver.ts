...
import { CountryType } from '@ms-api-gateway/modules/ms1/country/server/graphql/country.type';
import {
  CreateCountryInput,
  UpdateCountryInput,
  DeleteCountryInput,
  SearchCountryInput,
} from '@ms-api-gateway/modules/ms1/country/server/graphql/country.input';
