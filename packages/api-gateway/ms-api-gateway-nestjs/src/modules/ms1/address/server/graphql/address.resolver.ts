...
import { AddressType } from '@ms-api-gateway/modules/ms1/address/server/graphql/address.type';
import {
  CreateAddressInput,
  UpdateAddressInput,
  DeleteAddressInput,
  SearchAddressInput,
} from '@ms-api-gateway/modules/ms1/address/server/graphql/address.input';
